...
int git_filebuf_open(git_filebuf *lock, const char *path, int flags, mode_t mode, bool core_longpaths);
int git_filebuf_open_withsize(git_filebuf *file, const char *path, int flags, mode_t mode, size_t size, bool core_longpaths);
