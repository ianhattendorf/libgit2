...
/*
 * Provides a large enough buffer to support Windows paths:  GIT_PATH_MAX is
 * 4096, corresponding to a maximum path length of 4095 characters plus a
 ...
 * 8 characters, a net gain of 6, so the maximum length is GIT_PATH_MAX+6.
 */
#define GIT_WIN_PATH_UTF16		GIT_PATH_MAX+6
 ...
 */
#define GIT_WIN_PATH_UTF8		((GIT_PATH_MAX - 1) * 3 + 1)
